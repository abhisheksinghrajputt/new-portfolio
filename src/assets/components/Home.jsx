        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="md:w-1/2 mt-12 md:mt-24 space-y-4 order-2 md:order-1">
            ...
            <p className="text-md text-gray-600 text-justify">
              I am a passionate Web Developer with a knack for creating dynamic and responsive web applications. I specialize in the MERN stack and am dedicated to writing clean, efficient, and scalable code.
            </p>
            <br />

            {/* Call to Action Buttons */}
            <div className="flex flex-col sm:flex-row items-start gap-4">
               <a href="#projects" className="bg-green-500 text-white font-semibold px-6 py-2 rounded-md hover:bg-green-600 duration-300">
                  View My Work
               </a>
               <a href="/path-to-your-cv.pdf" download className="bg-gray-700 text-white font-semibold px-6 py-2 rounded-md hover:bg-gray-800 duration-300">
                  Download CV
               </a>
            </div>
            <br />
            ...
            <div className="flex flex-col items-center md:flex-row justify-between space-y-6 md:space-y-0 mt-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex space-x-5">
                  <SiMongodb size={28} className="text-green-800 rounded-full cursor-pointer hover:scale-110 duration-300" title="MongoDB" />
                  <SiExpress size={28} className="rounded-full cursor-pointer hover:scale-110 duration-300" title="Express.js" />
                  <SiReact size={28} className="text-sky-500 rounded-full cursor-pointer hover:scale-110 duration-300" title="React" />
                  <SiNodedotjs size={28} className="text-green-600 rounded-full cursor-pointer hover:scale-110 duration-300" title="Node.js" />
                </div>
              </div>
            </div>
          </div>
